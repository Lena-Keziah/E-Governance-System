        ...
        taxPaymentForm.addEventListener('submit', async (event) => {
            ...
            if (isValid) {
                ...
                if (isPaymentSuccessful) {
                    ...
                    paymentStatusDiv.textContent = 'Payment successful! Your transaction ID: TXN' + Math.random().toString(36).substr(2, 9).toUpperCase();
                    ...
                    paymentStatusDiv.textContent = 'Payment failed. Please try again or contact support.';
                }
                paymentStatusDiv.style.display = 'block';

                submitBtn.disabled = false;
                submitBtn.innerHTML = 'Proceed to Payment <i class="fas fa-check-circle"></i>';
            }
        });
    }
